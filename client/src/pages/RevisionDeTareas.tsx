            ...
            <div className='flex flex-col w-2/3 bg-white m-20 text-black text-left pl-24 pt-16'>
                ...
                <div className=' flex flex-col w-4/5 bg-white text-black'>
                    ...
                    <p className='py-4 text-justify px-4 border border-black w-full h-32'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolor cum asperiores doloribus officiis mollitia rem doloremque incidunt temporibus, pariatur, enim corrupti amet culpa repellat itaque totam ea perspiciatis provident cumque.
                    </p>
                </div>
